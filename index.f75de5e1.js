...
const totalPopulation = populationArr.reduce((sum, population)=>sum + population, 0);
...
document.querySelector(".average-population").textContent = avaragePopulation.toLocaleString("en-US");
